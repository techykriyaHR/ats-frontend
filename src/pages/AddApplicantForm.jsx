    ...
    <>
      <div className="min-h-screen bg-white p-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-96 p-6 bg-white rounded-lg border border-gray-light">
            ...
            {duplicates.length > 0 ? (
              <div className="space-y-4 max-h-200 overflow-auto pr-2">
                {duplicates.slice(0, 3).map((duplicate, index) => (
                  <div
                    key={index}
                    className="border border-gray-light rounded-lg p-4 space-y-2 hover transition-shadow"
                  >
                    {duplicate.applicantFromDb && (
                      <>
                        <h3 className="body-regular text-gray-dark">
